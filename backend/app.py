...
def create_app(test_config=None):
    ...
    from backend.routes import auth_routes, main_routes, product_routes, inventory_routes, sales_routes, customer_routes, expense_routes, dashboard_routes, analytics_routes
